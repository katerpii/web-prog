...
public class AuthCallbackGoogleController {
    ...
    @GetMapping
    public ResponseEntity<?> handleGoogleAuthCallback(@RequestParam("code") String code, @RequestParam("state") String state, HttpSession session, HttpServletResponse response) throws IOException {
